...
import com.ariks.MolecularRF.util.InvWrapperRestricted;
...
public abstract class TileExampleInventory extends TileExampleContainer implements IInventory, ISidedInventory {
    ...
    @Override
    public Container createContainer(@NotNull InventoryPlayer inventoryPlayer, @NotNull EntityPlayer entityPlayer) {return null;}
    @Override
