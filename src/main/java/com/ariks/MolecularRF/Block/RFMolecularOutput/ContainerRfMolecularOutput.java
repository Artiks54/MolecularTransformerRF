...
public class ContainerRfMolecularOutput extends ExampleContainer {
    public ContainerRfMolecularOutput(InventoryPlayer inventoryPlayer, TileRfMolecularOutput tileEntity, EntityPlayer entityPlayer) {
        super(tileEntity);
        this.addSlotToContainer(new Slot(tileEntity,0,16,6));
        this.addSlotToContainer(new SlotOut(tileEntity,1,6,55));
        this.addSlotToContainer(new SlotOut(tileEntity,2,26,55));
