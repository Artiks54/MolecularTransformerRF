...
public class GuiRfMolecularDouble extends ExampleGuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        int xOffset = 55;
        int yOffset = 5;
        this.fontRenderer.drawStringWithShadow(ItemInput, xOffset, yOffset, Color.GREEN.getRGB());
        this.fontRenderer.drawStringWithShadow(ItemInput2, xOffset, yOffset + 10, Color.GREEN.getRGB());
        this.fontRenderer.drawStringWithShadow(ItemOutput, xOffset, yOffset + 20, Color.GREEN.getRGB());
        this.fontRenderer.drawStringWithShadow(EnergyNeed, xOffset, yOffset + 30, Color.GREEN.getRGB());
        this.fontRenderer.drawStringWithShadow(Collected, xOffset, yOffset + 40, Color.GREEN.getRGB());
        this.fontRenderer.drawStringWithShadow(RfPerTick, xOffset, yOffset + 50, Color.GREEN.getRGB());
        this.fontRenderer.drawStringWithShadow(Time, xOffset, yOffset + 60, Color.GREEN.getRGB());
    }
}